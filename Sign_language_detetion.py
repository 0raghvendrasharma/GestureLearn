...
def app():
    ...
    # if st.sidebar.button('Go to Math Solver'):
    #     st.session_state.page = "math_solver"

    st.sidebar.title('Gesture-Learn')
    ...
    app_mode = st.sidebar.selectbox('Change the mode',
    ['Sign Language to Text','Speech to sign Language','Text to sign Language'])
    ...
    if app_mode == 'Sign Language to Text':
        ...
        st.title('Speech to Sign Language - Indian Sign Language')
        ...
        if st.button("Start Talking"):
            ...
            # convert text to lowercase if not empty
            if text:
                text = text.lower()
        ...
        st.title('Text to Sign Language - Indian Sign Language')
